        ...
        assertSoftly(document.occurrencesList) {
            withClue(this) {
                ...
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/Color#"
                    range { startLine = 4; startCharacter = 23; endLine = 4; endCharacter = 28 }
                })
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/Color#RED."
        ...
        assertSoftly(document.occurrencesList) {
            withClue(this) {
                ...
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/MySingleton#"
                    range { startLine = 5; startCharacter = 12; endLine = 5; endCharacter = 23 }
                })
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/MySingleton#hello()."
        ...
        assertSoftly(document.occurrencesList) {
            withClue(this) {
                ...
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/Foo#"
                    range { startLine = 7; startCharacter = 12; endLine = 7; endCharacter = 15 }
                })
                // Foo.Factory is a FirResolvedQualifier spanning the full qualifier expression
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/Foo#Factory#"
                    range { startLine = 7; startCharacter = 12; endLine = 7; endCharacter = 23 }
                })
                shouldContain(SymbolOccurrence {
                    role = Role.REFERENCE
                    symbol = "sample/Foo#Factory#create()."
